...
Natures = exports.Natures = ['Adamant', 'Bashful', 'Bold', 'Brave', 'Calm', 'Careful', 'Docile',
...
function getData() {
	try {
		Pokedex = exports.Pokedex = App.data.getPokedex();
		Movedex = exports.Movedex = App.data.getMoves();
		Itemdex = exports.Itemdex = App.data.getItems();
		Abilitydex = exports.Abilitydex = App.data.getAbilities();
		FormatData = exports.FormatData = App.data.getFormatsData();
	} catch (e) {
		return e;
	}
}
...
let randomPoke = exports.randomPoke = function () {
...
let randomMove = exports.randomMove = function () {
...
let randomItem = exports.randomItem = function () {
...
let randomAbility = exports.randomAbility = function () {
...
let randomNature = exports.randomNature = function () {
