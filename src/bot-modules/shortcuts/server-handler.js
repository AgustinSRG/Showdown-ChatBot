	...
	function commandsHandler(context, html) {
		...
		if (context.post.add) {
			...
			if (!error) {
				...
				ok = 'Shortcut command "' + Text.escapeHTML(cmd) + '" was created';
			}
			...
			if (!error) {
				...
				ok = 'Shortcut command "' + Text.escapeHTML(cmd) + '" was modified successfully';
			}
			...
			if (!error) {
				...
				ok = 'Shortcut command "' + Text.escapeHTML(cmd) + '" was deleted';
			}
		}
