...
const FAKE_USER_AGENT = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36";
...
function wget(url, callback) {
	...
	HTTPS.get(url, {
		headers: {
			// Headers used to simulate a browser context
